...
const GuildSettings = require("../models/PrefixSchema");
...
module.exports = async (client) => {
  ...
  // Ex: client.config key: https://localhost/ will have - hostname: localhost, protocol: http
  ...
  */
  ...
  const renderTemplate = (res, req, template, data = {}) => {
    ...
    //console.log(res.render(path.resolve(`${templateDir}${path.sep}${template}`), Object.assign(baseData, data)))
  ...
  app.get("/", (req, res) => {
    ...
    res.render(`${process.cwd()}/src/dashboard/templates/index.ejs`, baseData)
  });

  // Dashboard endpoint.
  app.get("/dashboard", checkAuth, (req, res) => {
    //renderTemplate(res, req, "dashboard.ejs", { perms: Discord.Permissions });
    res.render(`${process.cwd()}/src/dashboard/templates/dashboard.ejs`, { perms: Permissions, bot: client, user: req.isAuthenticated() ? req.user : null, path: req.path })
  });
  ...
  app.get("/dashboard/:guildID", checkAuth, async (req, res) => {
    ...
    res.render(`${process.cwd()}/src/dashboard/templates/settings.ejs`, { bot: client, user: req.isAuthenticated() ? req.user : null, path: req.path, settings: storedSettings, alert: null, guild: guild })
  });
    ...
    app.post("/dashboard/:guildID", checkAuth, async (req, res) => {
        ...
        res.render(`${process.cwd()}/src/dashboard/templates/settings.ejs`, { guild, settings: storedSettings, alert: "Your settings have been saved." })
    });
